...
define('css!../libs/libs-frontend-PLGraph/dist/css/plGraph.min',[],function(){});

define('css!../css/cosmattcomprewidget',[],function(){});

(function ($) {

    $.fn.ProfitLossCurve = function (options) {

        var largeVal = $('<div class="plGraphContainer"></div>');
        var chartAreahtml = "<div class='row plGraphWrapper' > <div class='plGraphAreaParent col-12'> <div class='plGraphArea'> <div class='plGraph'> <canvas id='myChart' width=410 height=280></canvas> </div> </div> </div> <div class='IOgroupParent groupParent-input col-6'> <div class='plgroup-slider'> <div class='plDivheading'>Input Values</div> <div> <div class='row plsliderContainer'> <div class='col-1 pllabelBulletStyle'> <span class='plLabeldot'></span> </div> <div class='plslider-Title col-5'><span class='plslider-TitleStyle' id='mfSliderTitle' > </span></div> <div class='plslider-length col-4 '> <div class='slider-horizontal plsizeSlider'> <input id='plvalue2' type='range' class='plslider' id='myRange' name='Price' value='0' step='1' /> </div> </div> <div class='col-2 sliderValDisplay'> <span class='plsliderrange' id='price'>50</span> </div> </div> <div class='row plsliderContainer'> <div class='col-1 pllabelBulletStyle'> <span class='plLabeldot'></span> </div> <div class='col-5 plslider-Title'><span class='plslider-TitleStyle' id='fcSliderTitle' > </span></div> <div class='plslider-length col-4'> <div class='slider-horizontal plsizeSlider'> <input id='plvalue1' type='range' name='Fixed Cost' class='plslider' id='myRange' value='0' step='100' /> </div> </div> <div class='col-2 sliderValDisplay'> <span class='plsliderrange' id='fixedCost'>15000</span> </div> </div> <div class='row plsliderContainer'> <div class='col-1 pllabelBulletStyles'> <span class='plLabeldot'></span> </div> <div class='col-5 plslider-Title'><span class='plslider-TitleStyle' id='vcSliderTitle'> </span></div> <div class='plslider-length col-4'> <div class=' slider-horizontal plsizeSlider'> <input id='plvalue3' type='range' name='Variable Per Cost' class='plslider' id='myRange' value='0' step='1' /> </div> </div> <div class='col-2 sliderValDisplay'> <span class='plsliderrange' id='varCostPerUnit'>10</span> </div> </div> </div> </div> </div> <div class='IOgroupParent groupParent-output col-6'> <div class='plgroup-text '> <div class='plDivheading'>Break Even Point</div> <div class='plconclusion'> <span class='plBepLabel'>Break-Even Point Value:</span> <span id='bep'></span> </div> <div class='plConclusionPara'>This is the number of members required for revenue to be equal to cost. Therefore, no profit no loss situation will be occured.</div> </div> </div> </div>";

         var $container = $(this);

        largeVal.append($(chartAreahtml));
        $(this).append(largeVal);
        ...
        var defaults = {
            "chart": {
                "chartelements": {
                    "title": {
                        "display": true,
                        "text": "Monthly Profit and Loss Chart",
                        "style": {
                            "fontstyle": "bold",
                            "fontcolor": "#3c3c3c",
                            "fontsize": 16,
                ...
                "slidervalues": [
                   ...
                   {
                       "sliderid": "variablecost",
                       "sliderlabel": "Variable Cost ($)",
                       "unit": "$",
                       "defaultval": 20,
                       "minval": 15,
                       "maxval": 25
                   ...
                   {
                       "sliderid": "membershipfee",
                       "sliderlabel": "Membership Fee ($)",
                       "unit": "$",
                       "defaultval": 55,
                       "minval": 50,
                       "maxval": 60
        ...
        var chartOptions;
        var fixedCostPoints = [];
        var variableCostPoints = [];
        var membershipFeePoints = [];
		var data4= [];
        var sliderValuesData = [];
        var fixedCostDetails = [];
        var varCostDetails = [];
        var sliderValuesData = [];
        var chart;
        var xAxesPoints = [];
        ...
        json = settings;
         ...
         function getDefaultFixedCost() {
             return (chart.slidervalues[0]).defaultval;
         }

         function getDefaultVariableCost() {
             return (chart.slidervalues[1]).defaultval;
         }


         function getDefaultMembershipFeesCost() {
             return (chart.slidervalues[2]).defaultval;
         }

        chart = settings.chart;


        var xAxes = settings.chart.chartelements.axes.xaxes;
        var minxAxes = xAxes.minval;
        var maxxAxes = xAxes.maxval;
        var stepSizeAxes = xAxes.stepsize;


        var point = minxAxes;
        while (point <= maxxAxes) {
            xAxesPoints.push(point);
            point += stepSizeAxes;
        }


		var chartCurrentVal =  $(".plGraphContainer");
			
        fixedCostDetails = chart.slidervalues[0];
        varCostDetails = chart.slidervalues[1];
        membershipfeeDetails = chart.slidervalues[2];

        sliderValuesData = chart.slidervalues;


		
		
        // paintChart(sliderValuesData, xAxesPoints);

		var slider1_values = chartCurrentVal.find('#plvalue1')[0];
		var slider2_values = chartCurrentVal.find('#plvalue3')[0];
		var slider3_values = chartCurrentVal.find('#plvalue2')[0];
		var breakEvenPointValueElement = chartCurrentVal.find('#bep')[0];
		
		var fixedCstVal = chartCurrentVal.find('#fixedCost')[0].innerHTML;
		var vrcVal = chartCurrentVal.find('#varCostPerUnit')[0].innerHTML;
		var prcVal = chartCurrentVal.find('#price')[0].innerHTML;
			
		
        //Slider_1 specifications
        slider1_values.min = chart.slidervalues[0].minval;
        slider1_values.max = chart.slidervalues[0].maxval;
        slider1_values.value = getDefaultFixedCost();
        chartCurrentVal.find('#fixedCost')[0].innerHTML = getDefaultFixedCost();
        chartCurrentVal.find('#fcSliderTitle')[0].innerHTML = chart.slidervalues[0].sliderlabel;

		//Slider_2 specifications
        slider2_values.value = getDefaultVariableCost();
        slider2_values.min = chart.slidervalues[1].minval;
        slider2_values.max = chart.slidervalues[1].maxval;
        chartCurrentVal.find('#varCostPerUnit')[0].innerHTML = getDefaultVariableCost();
        chartCurrentVal.find('#vcSliderTitle')[0].innerHTML = chart.slidervalues[1].sliderlabel;


       //Slider_3 specifications
        slider3_values.value = getDefaultMembershipFeesCost();
        slider3_values.min = chart.slidervalues[2].minval;
        slider3_values.max = chart.slidervalues[2].maxval;
         chartCurrentVal.find('#price')[0].innerHTML = getDefaultMembershipFeesCost();
         chartCurrentVal.find('#mfSliderTitle')[0].innerHTML = chart.slidervalues[2].sliderlabel;


        var fixedCst = parseInt(fixedCstVal);
        var vrc = parseInt(vrcVal);
        var prc = parseInt(prcVal);


        var brkevnpnt = fixedCst / (prc - vrc);
        var roundBrkevnpnt = Math.round(brkevnpnt);
        breakEvenPointValueElement.innerHTML = roundBrkevnpnt;
    ...
    afterDatasetsDraw: function (chart) {
        ...
        for (var d = 0; d < datasets.length; d++) {
            ...
            for (var p = 0; p < meta1.data.length-1;p++) {
              ...
              ctxn.moveTo(curr._view.x, curr._view.y);
              ctxn.lineTo(curr._view.x, curr._view.y);
              if (curr._view.steppedLine === true) {
                ctxn.lineTo(next._view.x, curr._view.y);
                ctxn.lineTo(next._view.x, next._view.y);
              }
              ...
              if (curr._view.steppedLine === true) {
                ctxn.lineTo(curr._view.x, next._view.y);
                ctxn.lineTo(next._view.x, next._view.y);
              }
              else if (next._view.tension === 0) {
                ctxn.lineTo(next._view.x, next._view.y);
              ...
              ctxn.closePath();
              ctxn.fillStyle = dataset.fillBetweenColor || "rgba(0,0,0,0.1)";
              ctxn.fill();
            } // end for p loop
        }
...
//Chart.pluginService.register(fillBetweenLinesPlugin);
        ...
        ctx = chartCurrentVal.find('#myChart')[0].getContext("2d");
        myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [
                    ...
                    {
                        label: json.chart.chartelements.chartlinestyles.lines[2].linelabelname,
                        data: membershipFeePoints,
                        showLine: json.chart.chartelements.chartlinestyles.lines[2].display,
						//fill: -1,
					    // tension: 0,
					    fillBetweenSet: 1,
					    fillBetweenColor: "rgba(0,0,0,0.1)",
                        fill: json.chart.chartelements.chartlinestyles.lines[2].fill,
                        borderWidth: json.chart.chartelements.chartlinestyles.lines[2].borderwidth,
                        borderColor: json.chart.chartelements.chartlinestyles.lines[2].bordercolor,
                        backgroundColor: json.chart.chartelements.chartlinestyles.lines[2].backgroundcolor
                    },
                    {
                        label: json.chart.chartelements.chartlinestyles.lines[1].linelabelname,
                        data: variableCostPoints,
                        showLine: json.chart.chartelements.chartlinestyles.lines[1].display,
                         fill: json.chart.chartelements.chartlinestyles.lines[1].fill,
				      //borderColor: "#00F",
						 // fill: 1,
						  // tension: 0.5,
                        borderWidth: json.chart.chartelements.chartlinestyles.lines[1].borderwidth,
                        borderColor: json.chart.chartelements.chartlinestyles.lines[1].bordercolor,
                        backgroundColor: json.chart.chartelements.chartlinestyles.lines[1].backgroundcolor
                    },
                    {
                        label: json.chart.chartelements.chartlinestyles.lines[0].linelabelname,
                        data: fixedCostPoints,
                        showLine: json.chart.chartelements.chartlinestyles.lines[0].display,
                       fill: json.chart.chartelements.chartlinestyles.lines[0].fill,
					    //fill: false,
						  // tension: 0,
						  //fillBetweenSet: 1,
						  fillBetweenColor: "rgba(5,5,255, 0.2)",

                        borderWidth: json.chart.chartelements.chartlinestyles.lines[0].borderwidth,
                        borderColor: json.chart.chartelements.chartlinestyles.lines[0].bordercolor,
                        backgroundColor: json.chart.chartelements.chartlinestyles.lines[0].backgroundcolor
                    },
					{
                       ...
                       showLine: true,
						fill: false,
                        // borderDash     : [0,2],
					    borderColor: 'rgba(5,5,255, 0.2)',
						backgroundColor: 'rgba(5,5,255, 0.2)'
                    }
			...
			responsive: true,
                ...
                title: {
                    display: true,
					position: 'top',
                    text: json.chart.chartelements.title.text,
                    fontStyle: json.chart.chartelements.title.style.fontstyle,
                    fontColor: json.chart.chartelements.title.style.fontcolor,
                    fontSize: json.chart.chartelements.title.style.fontsize,
                    fontFamily: json.chart.chartelements.title.style.fontfamily,
                    backgroundColor: json.chart.chartelements.title.style.backgroundcolor
                },
                 ...
                 tooltips: {
					 ...
					 callbacks: {
						label: function(tooltipItem, data) {
						  ...
						  var tooltipVal = parseInt(breakEvenPointValueElement.innerHTML);
						  var yval = tooltipVal * prc;
						 // console.log(yval);
						   
						  var label = data.datasets[tooltipItem.datasetIndex].label;
						  var value = data.datasets[tooltipItem.datasetIndex].data[tooltipItem.index];
						  if(tooltipItem.datasetIndex == 3 && tooltipItem.index == 0 )
								{
									return "Total Revenue at Break Even: "+ yval;
								}
								if(tooltipItem.datasetIndex == 3 && tooltipItem.index == 3 )
								{
									return "Number of members required to achieve Break Even : " + tooltipVal;
								}
						  
							  if(data.datasets[tooltipItem.datasetIndex].data[tooltipItem.index].x == tooltipVal ){
								if(tooltipItem.datasetIndex == 3 && tooltipItem.index == 2 )
								{
									return "";
								}
								else
								{
									return 'Break Even at' + ': ' +tooltipVal;
								}
                ...
                scales: {
                    yAxes: [{
                        ...
                        scaleLabel: {
                            display: true,
                            labelString: json.chart.chartelements.axes.yaxes.label,
							fontColor:'#545454',
							fontFamily:'Open Sans, sans-serif',
							fontSize:14
                        },
                        display: true,
                        ticks: {
                            min: json.chart.chartelements.axes.yaxes.minval,
                            max: json.chart.chartelements.axes.yaxes.maxval,
                            stepSize: json.chart.chartelements.axes.yaxes.stepsize,
                    ...
                    xAxes: [{
                        ...
                        display: json.chart.chartelements.axes.xaxes.display,
                        scaleLabel: {
                            display: true,
                            labelString: json.chart.chartelements.axes.xaxes.label,
							fontColor:'#545454',
							fontFamily:'Open Sans, sans-serif',
							fontSize:14
                        },
                        ticks: {
                            min: json.chart.chartelements.axes.xaxes.minval,
                            max: json.chart.chartelements.axes.xaxes.maxval,
                            stepSize: json.chart.chartelements.axes.xaxes.stepsize
        ...
        function paintChart(sliderValuesData, xAxesPoints) {

            var fixedCst = parseInt(chartCurrentVal.find('#fixedCost')[0].innerHTML);
			                   
            var vrc = parseInt(chartCurrentVal.find('#varCostPerUnit')[0].innerHTML);
            var prc = parseInt(chartCurrentVal.find('#price')[0].innerHTML);


            var brkevnpnt = fixedCst / (prc - vrc);
            var roundBrkevnpnt = Math.round(brkevnpnt);
            breakEvenPointValueElement.innerHTML = roundBrkevnpnt;
			var ttval = roundBrkevnpnt * prc;

            var fixedCostVal = sliderValuesData[0].selectedVal == undefined ? sliderValuesData[0].defaultval : sliderValuesData[0].selectedVal;
            var variableCostVal = sliderValuesData[1].selectedVal == undefined ? sliderValuesData[1].defaultval : sliderValuesData[1].selectedVal;
            var membershipFeesVal = sliderValuesData[2].selectedVal == undefined ? sliderValuesData[2].defaultval : sliderValuesData[2].selectedVal;


            fixedCostPoints = [];
            variableCostPoints = [];
          //  membershipFeePointsOld = [{x:100,y:5000},{x:200,y:10000},{x:445,y:15000},{x:600,y:45000},];
			membershipFeePoints = [];
			//data4 =[{x: 0,y:ttval},{x: roundBrkevnpnt,y:ttval},{x: roundBrkevnpnt,y:ttval},{x: roundBrkevnpnt,y:0}];
			data4 =[{x: 0,y:ttval},{x: roundBrkevnpnt,y:ttval},{x: roundBrkevnpnt,y:ttval},{x: roundBrkevnpnt,y:0}];

            for (var i = 0; i < sliderValuesData.length; i++) {
                var ele = sliderValuesData[i];

                if (ele.sliderid.toLowerCase() == "fixedcost") {
                    for (var j = 0; j < xAxesPoints.length; j++) {
                        fixedCostPoints.push({
                            "x": xAxesPoints[j],
                            "y": fixedCostVal
                        });
                ...
                } else if (ele.sliderid.toLowerCase() == "variablecost") {

                    for (var j = 0; j < xAxesPoints.length; j++) {
                        variableCostPoints.push({
                            "x": xAxesPoints[j],
                            "y": fixedCostVal + xAxesPoints[j] * variableCostVal
                        });
                    }

                } else if (ele.sliderid.toLowerCase() == "membershipfee") {
                    for (var j = 0; j < xAxesPoints.length; j++) {
                        membershipFeePoints.push({
                            "x": xAxesPoints[j],
                            "y": xAxesPoints[j] * membershipFeesVal
        ...
        function updateChart() {
            ...
            chart.slidervalues[0]["selectedVal"] = parseInt(chartCurrentVal.find('#fixedCost')[0].innerHTML);
            chart.slidervalues[1]["selectedVal"] = parseInt(chartCurrentVal.find('#varCostPerUnit')[0].innerHTML);
            chart.slidervalues[2]["selectedVal"] = parseInt(chartCurrentVal.find('#price')[0].innerHTML);


            paintChart(chart.slidervalues, xAxesPoints);



            myChart.data.datasets[0].data = membershipFeePoints;
            myChart.data.datasets[1].data = variableCostPoints;
            myChart.data.datasets[2].data = fixedCostPoints;
			 var fixedCst = parseInt(chartCurrentVal.find('#fixedCost')[0].innerHTML);
            var vrc = parseInt(chartCurrentVal.find('#varCostPerUnit')[0].innerHTML);
            var prc = parseInt(chartCurrentVal.find('#price')[0].innerHTML);
			...
			myChart.data.datasets[3].data = [{x: 0,y:ttval},{x: roundBrkevnpnt,y:ttval},{x: roundBrkevnpnt,y:ttval},{x: roundBrkevnpnt,y:0}];
        ...
        function testing() {
            alert("The text has been changed new");
        }

        function get_nextsibling(n) {
            x = $(n).parents('.plsliderContainer');
            // while (x.nodeType != 1) {
                // x = x.nextSibling;
            // }
			return x.find('.plsliderrange')[0];
        }
        ...
        $(function () {
            ...
            var $window = $(window).on('resize', function () {
                ...
                if ($('.plGraphContainer').width() >= 1020) {
                    currentState = "large";
                }
                else if ($('.plGraphContainer').width() >= 600 && $('.plGraphContainer').width() < 1020) {
                    currentState = "medium";
                }
                else if ($('.plGraphContainer').width() < 600) {
                    currentState = "small";
                }
                ...
                if (currentState == lastState) {
                    ...
                    if (currentState == "large") {
                        ...
                        var $panelgroupParentMain = $(".groupParent-input");
                        var $panelGroupText = $(".plgroup-text");
                        $panelgroupParentMain.append($panelGroupText);
                        $('.groupParent-output').remove();
                        $(".plGraphAreaParent").removeClass('col-12').addClass('col-8');
						
						
                        if (lastState == "medium"){
							 $(".plGraphAreaParent").removeClass('col-12').addClass('col-8');
                        }
                        else if (lastState == "small") {
                            $(".IOgroupParent").removeClass('col-12').addClass('col-4');
                        }
						$(".plGraphContainer").attr('class', 'plGraphContainer');
						$(".IOgroupParent").attr('class', 'IOgroupParent IOgroupParent-large groupParent-input col-4')
					    $(".plgroup-slider").attr('class', 'plgroup-slider plgroup-slider-large');
						$(".plgroup-text").attr('class', 'plgroup-text plgroup-text-large');
                    }
                    else if (currentState == "medium") {						
                        if (lastState == "large") {
                            $('.groupParent-input').clone().addClass('groupParent-output').removeClass('groupParent-input').appendTo('.plGraphWrapper');
                            $('.groupParent-input .plgroup-text').remove();
                            $('.groupParent-output .plgroup-slider').remove();
                            $('.plGraphAreaParent').removeClass('col-8').addClass('col-12');
						...
						$(".plGraphContainer").attr('class', 'plGraphContainer');
						$(".groupParent-input").attr('class', 'IOgroupParent groupParent-input col-6');
						$(".groupParent-output").attr('class', 'IOgroupParent groupParent-output col-6');
					    $(".plgroup-slider").attr('class', 'plgroup-slider');
						$(".plgroup-text").attr('class', 'plgroup-text');
                    }
                        ...
                        if (lastState == "large") {
                            ...
                            $('.groupParent-output .plgroup-slider').remove();
                            $('.plGraphAreaParent').removeClass('col-8').addClass('col-12');
                            $('.IOgroupParent').removeClass('col-4').addClass('col-12');
						//new
						$(".plsliderContainer").attr('class', 'row plsliderContainer plsliderContainer-small');		
						$(".plDivheading").attr('class', 'plDivheading plDivheading-small');					
                        }                        
                        else if (lastState == "medium") {
                           $(".IOgroupParent").removeClass('col-6').addClass('col-12');
							
                        }
						
						$(".plGraphContainer").attr('class', 'plGraphContainer plGraphContainer-small');
						$(".groupParent-input").attr('class', 'IOgroupParent IOgroupParent-small groupParent-input col-12');
						$(".groupParent-output").attr('class', 'IOgroupParent IOgroupParent-small groupParent-output col-12');
						$(".plgroup-slider").attr('class', 'plgroup-slider');
						$(".plgroup-text").attr('class', 'plgroup-text');
                    }
...
(function ($) {
    ...
    $.fn.ProfitLossCurve = function (options) {
		...
		var chartCurrentVal =  $container.find(".plGraphContainer");
...
typeof define === 'function' && define.amd ? define('../libs/libs-frontend-PLGraph/dist/js/plGraph.js',['require'], function(require) { return factory(function() { try { return require('moment'); } catch(e) { } }()); }) :
