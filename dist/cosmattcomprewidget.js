...
(function ($) {
  ...
  $.fn.comprehensiveWidget = function (options) {
    ...
    var autoResizer = function (params) {
  ...
  function(cosmattcomprewidgetTemplateRef) {
    ...
    cosmattcomprewidget = function() {
      ...
      var __config = {
        ...
        RESIZE_HEIGHT: "2038" /* Applicable, if RESIZE_MODE is manual. If RESIZE_HEIGHT is defined in TOC then that will overrides. */
      ...
      */
      ...
      debugger;
        ...
        var $pluginArea = $('<div class="col-sm-12 widgetContainer"></div>');
